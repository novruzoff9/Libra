...
public class CategoriesController : Controller
{
    ...
    public CategoriesController(AdminAppDbContext context)
    {
        _context = context;
    }
    ...
    {
        var adminAppDbContext = _context.Categories.Include(c => c.ParentCategory);
        return View(await adminAppDbContext.ToListAsync());
    }
